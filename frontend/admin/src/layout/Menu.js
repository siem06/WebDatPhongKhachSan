    ...
    <div className="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul className="navbar-nav">
        <li className="nav-item">
          {/* <a className="nav-link text-white active bg-gradient-primary" href="/home">
            <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i className="material-icons opacity-10">dashboard</i>
            </div>
            <span className="nav-link-text ms-1">Trang chủ</span>
          </a> */}
          <NavLink className="nav-link text-white active bg-gradient-primary" exact to="/home" activeClassName="active">
          <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i className="material-icons opacity-10">dashboard</i>
            </div>
            <span className="nav-link-text ms-1">Trang chủ</span>
        ...
        <li className="nav-item">
          {/* <a className="nav-link text-white " href="/manageroom">
            <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i className="material-icons opacity-10">table_view</i>
            </div>
            <span className="nav-link-text ms-1">Quản lý phòng</span>
          </a> */}
          <NavLink className="nav-link text-white " to="/manageroom" activeClassName="active">
          <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i className="material-icons opacity-10">table_view</i>
            </div>
            <span className="nav-link-text ms-1">Quản lý phòng</span>
