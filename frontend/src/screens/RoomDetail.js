                        ...
                        <div className="vstack gap-5">
                                    ...
                                    <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                                        <div className="carousel-inner">
                                            <div className="carousel-item active">
                                                <img className="d-block w-100" src="img/room-1.jpg" alt="First slide" />
                                            </div>
                                            <div className="carousel-item">
                                                <img className="d-block w-100" src="img/room-2.jpg" alt="Second slide" />
                                            </div>
                                            <div className="carousel-item">
                                                <img className="d-block w-100" src="img/room-3.jpg" alt="Third slide" />
                                            </div>
                                        </div>
                                ...
                                <div className="card-body pt-4 ">
                                    <div className="row g-4">
                                        ...
                                        <div className="col-sm-6">
                                            <h6><i className="fa-solid fa-biking me-2"></i>Hoạt động</h6>
                                            {/* <!-- List --> */}
                                            <ul className="list-group list-group-borderless mt-2 mb-0">
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Bể bơi
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Spa
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Khu vui chơi trẻ em
                                                </li>
                                                <li className="list-group-item pb-0">
                                        ...
                                        {/* <!-- Payment Method --> */}
                                        <div className="col-sm-6">
                                            <h6><i className="fa-solid fa-credit-card me-2"></i>Phương thức thanh toán</h6>
                                            {/* <!-- List --> */}
                                            <ul className="list-group list-group-borderless mt-2 mb-0">
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Thẻ tín dụng
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Tiền mặt
                                                </li>
                                        ...
                                        {/* <!-- Services --> */}
                                        <div className="col-sm-6">
                                            <h6><i className="fa-solid fa-concierge-bell me-2"></i>Dịch vụ</h6>
                                            {/* <!-- List --> */}
                                            <ul className="list-group list-group-borderless mt-2 mb-0">
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Giặt khô
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Dịch vụ phòng
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Dịch vụ đặc biệt
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Khu vực chờ
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i> Khu vực hút thuốc
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Trợ giúp đặc biệt
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Thiết bị giặt là
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Dịch vụ ủi
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Thang máy
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        {/* <!-- Safety & Security --> */}
                                        <div className="col-sm-6">
                                            <h6><i className="bi bi-shield-fill-check me-2"></i>An toàn &amp; Bảo mật</h6>
                                            {/* <!-- List --> */}
                                            <ul className="list-group list-group-borderless mt-2 mb-4 mb-sm-5">
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Bác sĩ trực
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Bảo vệ trực
                                                </li>
                                            </ul>

                                            <h6><i className="fa-solid fa-volume-up me-2"></i>Ngôn ngữ nhân viên</h6>
                                            {/* <!-- List --> */}
                                            <ul className="list-group list-group-borderless mt-2 mb-0">
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Tiếng Anh
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Tiếng Tây Ban Nha
                                                </li>
                                                <li className="list-group-item pb-0">
                                                    <i className="fa-solid fa-check-circle text-success me-2"></i>Tiếng Hin-đi
                                                </li>
                                            </ul>
                                        </div>
							...
							<!-- Leave review START --> */}
                                    <form className="mb-5">
                                        ...
                                        {/* <!-- Button --> */}
                                        <button type="submit" className="btn btn-lg btn-primary mb-0">Bài đánh giá<i className="bi fa-fw bi-arrow-right ms-2"></i></button>
                                    </form>
                                    {/* <!-- Leave review END --> */}
                                    ...
                                    <div className="d-md-flex my-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="mb-2">Đẹp trai gặp tranh luận sir tài liệu tuổi ở. Khi phong cách sống, anh ta khô hơn. Cung cấp liên quan để khách truy cập chúng tôi tư nhân loại bỏ. Vừa phải làm đối tượng với khoảng cách. </p>
                                    ...
                                    <div className="my-4 ps-2 ps-md-3">
                                        <div className="d-md-flex p-3 bg-light rounded-3">
                                            ...
                                            <div className="mt-2 mt-md-0">
                                                ...
                                                <p className="mb-0">Nhưng sự thận trọng thường xuyên thưa ngài, cô không bị ảnh hưởng bởi sự ngưỡng mộ mọi thứ. </p>
                                            </div>
                                        </div>
                                    </div>
                                    {/* <!-- Child review END --> */}
                                    ...
                                    <div className="d-md-flex my-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="mb-0">Đưa ra sự thất vọng cần thiết phản đối ông đã thắng thế. Ông cảm thấy chủ yếu là thân mật trong làm. Nước hẹn giờ điên rồ nhận thức đúng nếu oh sự thật. Lớn ở trên có nghĩa là. Dashwood cung cấp mạnh hơn là.</p>
                                        </div>
                                    </div>
                                    ...
                                    {/* <!-- Button --> */}
                                    <div className="text-center">
                                        <a href="#" className="btn btn-primary-soft mb-0">Tải thêm</a>
                                    </div>
                                </div>
                                {/* <!-- Card body END --> */}
                            </div>
                                ...
                                <div className="card-body pt-4 ">
                                    ...
                                    <ul className="list-group list-group-borderless mb-2">
                                        <li className="list-group-item d-flex">
                                            <i className="bi bi-check-circle-fill me-2"></i>Đây là một trang trại gia đình, do đó chúng tôi yêu cầu bạn không thưởng thức.
                                        </li>
                                        <li className="list-group-item d-flex">
                                            <i className="bi bi-check-circle-fill me-2"></i>Uống rượu và hút thuốc trong giới hạn có kiểm soát được cho phép tại trang trại nhưng vui lòng không tạo ra một mớ hỗn độn hoặc ồn ào tại nhà.
                                        </li>
                                        <li className="list-group-item d-flex">
                                            <i className="bi bi-check-circle-fill me-2"></i>Ma túy và các sản phẩm bất hợp pháp gây say đều bị cấm và không được mang đến nhà hoặc tiêu thụ.
                                        </li>
                                        <li className="list-group-item d-flex">
                                            <i className="bi bi-x-circle-fill me-2"></i>Đối với bất kỳ cập nhật nào, khách hàng sẽ thanh toán phí hủy/sửa đổi hiện hành.
                                        </li>
                                    </ul>
                                    ...
                                    <ul className="list-group list-group-borderless mb-2">
                                        <li className="list-group-item h6 fw-light d-flex mb-0">
                                            <i className="bi bi-arrow-right me-2"></i>Nhận phòng: 1:00 pm - 9:00 pm
                                        </li>
                                        <li className="list-group-item h6 fw-light d-flex mb-0">
                                            <i className="bi bi-arrow-right me-2"></i>Trả phòng: 11:00 sáng
                                        </li>
                                        <li className="list-group-item h6 fw-light d-flex mb-0">
                                            <i className="bi bi-arrow-right me-2"></i>Tự check-in với nhân viên tòa nhà
                                        </li>
                                        <li className="list-group-item h6 fw-light d-flex mb-0">
                                            <i className="bi bi-arrow-right me-2"></i>Không có vật nuôi
                                        </li>
                                        <li className="list-group-item h6 fw-light d-flex mb-0">
                                            <i className="bi bi-arrow-right me-2"></i>Không có tiệc tùng hoặc sự kiện
                                        </li>
                                        <li className="list-group-item h6 fw-light d-flex mb-0">
                                            <i className="bi bi-arrow-right me-2"></i>Hút thuốc được phép
                                        </li>
                                    </ul>
                                    ...
                                    <div className="bg-danger bg-opacity-10 rounded-2 p-3">
                                        <p className="mb-0 text-danger">Báo động khói không được báo cáo - Chủ nhà đã không báo cáo báo động khói trên tài sản. Chúng tôi khuyên bạn nên mang theo máy dò di động cho chuyến đi của mình.</p>
                                    </div>
                                </div>
                                {/* <!-- Card body END --> */}
                            </div>
